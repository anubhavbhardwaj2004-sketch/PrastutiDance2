          ...
          <div className="video-list">
            ...
            <div className="video-box-card">
              ...
              <div className="video-info-side">
                ...
                <span className="video-tag">Student Spotlight</span>
                <h3 className="video-title">Duet Expression</h3>
                <div className="video-divider"></div>
                <p className="video-desc">
                  Showcase of individual talent and free-flowing movement at the studio.
                </p>
              </div>
            </div>
